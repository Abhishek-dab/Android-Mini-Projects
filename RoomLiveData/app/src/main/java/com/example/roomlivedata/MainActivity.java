...
// UI --> ViewHolder --> Repository -->Studentdatabase --> Dao
//            |-> LiveData
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*database = Room.databaseBuilder(this, StudentDatabase.class, "MYDB") normal view
                .allowMainThreadQueries().fallbackToDestructiveMigration().build();*/

/*To initialise viewmodel*/
       ...
       /* List<Student>studentList = database.myDao().readData();
        for(int i=0; i<studentList.size();i++) {
            ...
            Toast.makeText(this, ""+studentList.get(i).getRollNumber()+"\n"+i, Toast.LENGTH_LONG).show();
        }*/
       //To retrive data
